...
--
-- Host: db
-- Tempo de geração: 22/01/2026 às 10:50
...
(8, 944, NULL, NULL, 'Nao abre o Editor de Texto', 'Santos Dumont   Osório', '2026-01-20 00:00:00', 'concluido', 'não', 130.00, 0.00, '', '2026-01-21 12:36:42', NULL, '14:00:00', '15:00:00', '1 ', 1, 'Computador da Frente Secretaria ', 'Reinstalado o software, voltou a funcionar. ');
...
(2033, 935, 33, 'INSTALAR OS PROGRAMAS PADRÕES', 'Instalação de aplicativos essenciais, incluindo navegação na internet, leitura de documentos, compactação de arquivos, acesso remoto, videoconferência e reprodução de mídia', 0.00, 190.00, 190.00, 80.00, 5, 'pago', 'entregue', 1, '2026-01-20 16:33:07', NULL),
...
(2035, 943, 35, 'Cliente estava com problema no teclado, levou em outra assistência, após a troca do teclado o teclado foi resolvido mas apresentou problema no touchpad.  ', 'Desmontagem e remontagem do equipamento', 0.00, 250.00, 250.00, 100.00, 9, 'pendente', 'nao_entregue', 1, '2026-01-20 19:45:07', NULL);
...
INSERT INTO `pagamentos_transacoes` (`id`, `tipo_origem`, `origem_id`, `maquina`, `forma`, `bandeira`, `parcelas`, `taxa_percentual`, `valor_bruto`, `valor_taxa`, `valor_liquido`, `usuario_id`, `ativo`, `created_at`) VALUES
(1, 'os', 2032, 'Ton', 'debito', 'mastercard', 1, 0.00, 219.90, 0.00, 219.90, 9, 1, '2026-01-21 18:28:39');
